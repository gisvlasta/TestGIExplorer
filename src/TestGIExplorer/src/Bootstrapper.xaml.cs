...
namespace TestGIExplorer {
  ...
  public partial class Bootstrapper : Application {
    ...
    private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e) {
      // TODO: IMPORTANT - AppEngine.LogError((Exception)e.ExceptionObject);
    }
    ...
    private void Application_DispatcherUnhandledException(object sender, System.Windows.Threading.DispatcherUnhandledExceptionEventArgs e) {
      // TODO: IMPORTANT - AppEngine.LogError(e.Exception);
    }
    ...
    private void Initialize() {
      ...
      // TODO: IMPORTANT - AppEngine.Instance.ReadConfiguration();
